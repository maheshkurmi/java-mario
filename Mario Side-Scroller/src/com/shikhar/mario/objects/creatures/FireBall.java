...
public class FireBall extends Creature {
	...
	public FireBall(int x, int y, float dir, MarioSoundManager22050Hz soundManager) {
		...
		aliveTime=0;
		if (!initialized) {
			fb_1 =  ImageManipulator.loadImage("baddies/fireball_1.png");
			fb_2 =  ImageManipulator.loadImage("baddies/fireball_2.png");
			fb_3 =  ImageManipulator.loadImage("baddies/fireball_3.png");
			fb_4 =  ImageManipulator.loadImage("baddies/fireball_4.png");
			fb_5 =  ImageManipulator.loadImage("baddies/fireball_5.png");
			fb_6 =  ImageManipulator.loadImage("baddies/fireball_6.png");
			initialized = true;
		}
