...
public class Spring extends Platform {
	...
	int bottomY;
	private static BufferedImage Spring_1 = ImageManipulator.loadImage("items/Spring_1.png");
	private static BufferedImage Spring_2 = ImageManipulator.loadImage("items/Spring_2.png");
	private static BufferedImage Spring_3 = ImageManipulator.loadImage("items/Spring_3.png");
	
	public Spring(int pixelX, int pixelY) {
	...
	public void jumpedOn() {
		if (this.currentAnimation()!=restore)this.setAnimation(restore);
	}
