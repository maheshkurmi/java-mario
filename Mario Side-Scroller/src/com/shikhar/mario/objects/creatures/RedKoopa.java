...
public class RedKoopa extends Creature {
	...
	public RedKoopa(int x, int y, MarioSoundManager22050Hz soundManager,boolean isGreen) {
		...
		r = new Random();
			...
			if (!isGreen) {
				left_1 = ImageManipulator.loadImage("baddies/Koopa_Red_Left_1.png");
				left_2 = ImageManipulator.loadImage("baddies/Koopa_Red_Left_2.png");
				right_1 = ImageManipulator.loadImage("baddies/Koopa_Red_Right_1.png");
				right_2 = ImageManipulator.loadImage("baddies/Koopa_Red_Right_2.png");
				shell = ImageManipulator.loadImage("baddies/Red_Shell_1.png");
				flipped = ImageManipulator.loadImage("baddies/Red_Shell_Flip.png");
			} else {
