...
public class RedShell extends Creature {
	...
	public RedShell(int x, int y, TileMap map, MarioSoundManager22050Hz soundManager, boolean isStill, boolean isGreen) {
		...
		this.isGreen=isGreen;
			if (!isGreen){
				stay = ImageManipulator.loadImage("baddies/Red_Shell_1.png");
				rotate_1 = ImageManipulator.loadImage("baddies/Red_Shell_2.png");
				rotate_2 = ImageManipulator.loadImage("baddies/Red_Shell_3.png");
				rotate_3 = ImageManipulator.loadImage("baddies/Red_Shell_4.png");
