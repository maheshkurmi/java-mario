...
public class QuestionBlock extends GameTile {
	...
	public QuestionBlock(int pixelX, int pixelY, TileMap map, MarioSoundManager22050Hz soundManager, boolean hasCoin,
		...
		if (q==null){
			...
			q[0] = ImageManipulator.loadImage("items/Question_Block_0.png");
			q[1] = ImageManipulator.loadImage("items/Question_Block_1.png");
			q[2] = ImageManipulator.loadImage("items/Question_Block_2.png");
			q[3] = ImageManipulator.loadImage("items/Question_Block_3.png");
			q[4] = ImageManipulator.loadImage("items/Question_Block_Dead.png");
		}
		Random r = new Random();
