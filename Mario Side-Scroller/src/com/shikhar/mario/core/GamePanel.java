...
public class GamePanel extends JPanel implements Runnable {
	...
	public GamePanel(int w, int h) {
		...
		try {
			...
			map = gameloader.loadMap("maps/map3.txt", SM_22050_Hz); // use the ResourceManager to load the game map
	...
	private void gameRender() {
		...
		renderer.draw((Graphics2D) dbg, map, backgroundMap, foregroundMap, panelWidth, panelHeight,false);
